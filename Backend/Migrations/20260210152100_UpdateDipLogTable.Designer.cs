...
namespace backend.Migrations
{
    ...
    [Migration("20260210152100_UpdateDipLogTable")]
    partial class UpdateDipLogTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.Rate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrentPrice = 280m,
                            FuelType = "Petrol",
                            LastUpdated = new DateTime(2026, 2, 10, 20, 20, 57, 174, DateTimeKind.Local).AddTicks(7261)
                        },
                        new
                        {
                            Id = 2,
                            CurrentPrice = 295m,
                            FuelType = "Diesel",
                            LastUpdated = new DateTime(2026, 2, 10, 20, 20, 57, 174, DateTimeKind.Local).AddTicks(7264)
                        },
                        new
                        {
                            Id = 3,
                            CurrentPrice = 600m,
                            FuelType = "Mobile Oil",
                            LastUpdated = new DateTime(2026, 2, 10, 20, 20, 57, 174, DateTimeKind.Local).AddTicks(7266)
                        },
                        new
                        {
                            Id = 4,
                            CurrentPrice = 330m,
                            FuelType = "Hi-Octane",
                            LastUpdated = new DateTime(2026, 2, 10, 20, 20, 57, 174, DateTimeKind.Local).AddTicks(7268)
                        });
                });
