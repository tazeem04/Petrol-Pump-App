...
namespace backend.Migrations
{
    ...
    [Migration("20260210110934_AddDipLogTable")]
    partial class AddDipLogTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.Rate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrentPrice = 280m,
                            FuelType = "Petrol",
                            LastUpdated = new DateTime(2026, 2, 10, 16, 9, 32, 357, DateTimeKind.Local).AddTicks(4744)
                        },
                        new
                        {
                            Id = 2,
                            CurrentPrice = 295m,
                            FuelType = "Diesel",
                            LastUpdated = new DateTime(2026, 2, 10, 16, 9, 32, 357, DateTimeKind.Local).AddTicks(4747)
                        },
                        new
                        {
                            Id = 3,
                            CurrentPrice = 600m,
                            FuelType = "Mobile Oil",
                            LastUpdated = new DateTime(2026, 2, 10, 16, 9, 32, 357, DateTimeKind.Local).AddTicks(4749)
                        },
                        new
                        {
                            Id = 4,
                            CurrentPrice = 330m,
                            FuelType = "Hi-Octane",
                            LastUpdated = new DateTime(2026, 2, 10, 16, 9, 32, 357, DateTimeKind.Local).AddTicks(4751)
                        });
                });
