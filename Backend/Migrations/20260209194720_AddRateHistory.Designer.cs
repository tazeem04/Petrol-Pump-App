...
namespace backend.Migrations
{
    ...
    [Migration("20260209194720_AddRateHistory")]
    partial class AddRateHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.Rate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrentPrice = 280m,
                            FuelType = "Petrol",
                            LastUpdated = new DateTime(2026, 2, 10, 0, 47, 18, 255, DateTimeKind.Local).AddTicks(340)
                        },
                        new
                        {
                            Id = 2,
                            CurrentPrice = 295m,
                            FuelType = "Diesel",
                            LastUpdated = new DateTime(2026, 2, 10, 0, 47, 18, 255, DateTimeKind.Local).AddTicks(346)
                        },
                        new
                        {
                            Id = 3,
                            CurrentPrice = 600m,
                            FuelType = "Mobile Oil",
                            LastUpdated = new DateTime(2026, 2, 10, 0, 47, 18, 255, DateTimeKind.Local).AddTicks(349)
                        },
                        new
                        {
                            Id = 4,
                            CurrentPrice = 330m,
                            FuelType = "Hi-Octane",
                            LastUpdated = new DateTime(2026, 2, 10, 0, 47, 18, 255, DateTimeKind.Local).AddTicks(352)
                        });
                });
